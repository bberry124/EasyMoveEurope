...
@section('content')
    <section id="get-a-quote" class="get-a-quote">
            ...
            <div class="row g-0">
                ...
                <form method="post" class="php-email-form">
                    ...
                    <div class="row mt-5 personal-section">
                        <div class="col-12 col-md-6 personal-infos mb-3">
                            ...
                            <div class="col-12 mt-4">
                                ...
                                <select class="form-control" id="pickup_country_select" name="pickup_country_select">
                                    @foreach(allCountries() as $key => $country)
                                        <option
                                                value="{{$key}}" {{isset(session('price_page')['pickup_country_select']) &&  session('price_page')['pickup_country_select'] == $key ? 'selected' : ''}}>{{$country}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="d-flex">
                                <div class="col-12 mt-4">
                                    <label class="form-check-label" for="sender_city">{{__("FIND THE ADDRESS")}}</label>
                        ...
                        <div class="col-12 col-md-6 personal-infos mb-3">
                            ...
                            <div class="col-12 mt-4">
                                ...
                                <select class="form-control" id="desti_country_select" name="desti_country_select">
                                    @foreach(allCountries() as $key => $country)
                                        <option
                                                value="{{$key}}" {{isset(session('price_page')['desti_country_select']) &&  session('price_page')['desti_country_select'] == $key ? 'selected' : ''}}>{{$country}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12 mt-4">
                                ...
                                <input value="{{session('price_page')['receiver'] ?? ""}}" type="text" name="receiver"
                                       id="receiver"
                                       class="form-control"
                                       placeholder={{__("Name & Surname")}}>
                    ...
                    <div class="mt-3 van-section">
                        ...
                        <div class="col-md-6 mt-4">
                            ...
                            <p class="error-valid" id="cargo_val_invalid"><i
                                        class="zmdi zmdi-alert-circle-o me-1"></i>{{__("Please enter the cargo value")}}</p>
                        </div>
                        <!-- <div class="col-12 mt-4">
                    ...
                    <div class="row mt-5 contact-area">
                        ...
                        <p class="desc-text"
                           style="margin-top:40px !important;">{{__("When do you want the pickup to take place?")}}</p>
                        <div class="col-md-6 mt-4">
                            ...
                            <p class="error-valid" id="collection_day_invalid"><i
                                        class="zmdi zmdi-alert-circle-o me-1"></i>{{__("Please enter the pickup date")}}</p>
                        </div>
                    ...
                    <div class="calculator d-flex flex-wrap" style="border:2px solid #c8c8c8; padding:10px;">
                        <div class="col-md-4 col-4 map_to_remove">
                            ...
                            <div class="esti-prices">
                                ...
                                <p id="price_value" style="position:relative;">{{__("Price:")}} € <span id="price_val"
                                                                                     ...
                                                                                     <span class="fa-solid fa-circle-info title-tip title-tip-up" style="font-size:18px; color:#6c6b6b; width:20px; height:20px; border-radius:20px; border:1px solid #ccc;">
                                                                       <span class="tooltiptext" style="font-size:15px!important; font-weight:500!important; font-family:Arial;">{{ __('The price includes all taxes. If you are a company, please') }} <a href="{{ url('whosignup') }}">{{ __('Open an Account') }}</a> {{ __('or') }} <a href="{{ route('login') }}">{{ __('Login') }}</a> {{ __('to enjoy the tax benefits.') }}</span>
                                                                       </span></p>
                                <div style="width:100%;">
                        ...
                        <div class="col-10 d-flex flex-wrap mt-3" id="service_footer2" style="display:none;">
                    ...
                    <div class="row measure-cell" id="createBtnBlock">
                            ...
                            <div class="d-flex flex-wrap" style="margin-top:20px;">
                                <span style="font-size:22px; font-weight:700; color:#000;">How would you like to pay?</span>
                            </div>
                            ...
                            <div class="col-md-4"><input type="button" id="btnBank" class="btn btn-primary btn-lg col-md-11" value="Bank Transfer" style="background-color:#000; font-size:22px; font-weight:600; border-radius:0; border:1px solid #000;" /></div>
                            <div class="col-md-4"><input type="button" id="btnOnline" class="btn btn-primary btn-lg col-md-11" value="Credit Card" style="background-color:#000; font-size:22px; font-weight:600; border-radius:0; border:1px solid #000;" /> </div>
                            <div class="col-md-2"></div>
                            @else
                            <div class="col-md-4"><input type="button" id="btnBank" class="btn btn-primary btn-lg col-md-11" value="Bank Transfer" style="background-color:#000; font-size:22px; font-weight:600; border-radius:0; border:1px solid #000;" /></div>
                            <div class="col-md-4"><input type="button" id="btnOnline" class="btn btn-primary btn-lg col-md-11" value="Credit Card" style="background-color:#000; font-size:22px; font-weight:600; border-radius:0; border:1px solid #000;" /> </div>
                            <div class="col-md-4"><input type="button" id="btnDeferred" class="btn btn-primary btn-lg col-md-11" value="Deferred Payment" style="background-color:#000; font-size:22px; font-weight:600; border-radius:0; border:1px solid #000;" /> </div>
                            @endif
                            </div>
                            </div>
                                    ...
                                    <div class="card shadow-lg">
                                        <div class="card-body small">
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{ asset('img/icon/capacity.svg') }}" alt="" class="me-2"
                                                             loading="lazy">
                                                        <span>Capacity (m<sup>3</sup>{{__(")")}}</span>
                                                    </td>
                                                    <td>{{__("19")}}</td>
                                                </tr>
                                                </tbody>
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-primary rounded-pill my-4"
                                                    ...
                                                    aria-expanded="false"
                                                    aria-controls="planeVanLayout">Show van layout
                                            </button>
                                            ...
                                            <p class="fw-bold text-uppercase">{{__("Curtain side is best for:")}}</p>
                                            <ul>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <p style="color: grey;"><span
                                                        style="font-weight: 600;">{{__("Curtain-Side van + Tail Lift:")}}</span>Total
                                                    capacity is 700kg (due the lift weight)
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card shadow-lg">
                                        <div class="card-body small">
                                            ...
                                            <button type="button"
                                                    ...
                                                    aria-expanded="false"
                                                    aria-controls="boxVanLayout">Show van layout
                                            </button>
                                            ...
                                            <ul>
                                                <li>High-value items requiring additional security measures (e.g.
                                                    electronics,
                                                    luxury)
                                                </li>
                                    ...
                                    <div class="accordion-header">
                                        <button
                                            ...
                                            <div class="col-4 text-start"><img
                                                    ...
                                                    alt="" class="me-4" loading="lazy"> <strong class="text-primary">Curtain
                                                    Sider</strong></div>
        ...
        <form id="invoice_submit" hidden action="{{url("/company/invoice_company")}}" method="post">
            {{csrf_field()}}

            <input type="hidden" name="sender" id="sender_submit">
            <input type="hidden" name="receiver" id="receiver_city_submit">
        ...
        <div class="fix-footer-wrapper container">
            ...
            <div class="col-md-3 col-6 measure-cell" style="position:relative;">
                    <h3 class="where-country" >{{__("Price:")}} € <span id="fixed_footer_price"
                                                                       ...
                                                                       <span class="fa-solid fa-circle-info title-tip title-tip-up" style="font-size:18px; color:#6c6b6b; width:20px; height:20px; border-radius:20px; border:1px solid #ccc;position:absolute; right:10px; top:10px;">
                                                                       <p class="tooltiptext" style="font-size:15px!important; font-weight:500!important; font-family:Arial;">{{ __('The price includes all taxes. If you are a company, please') }} <a href="{{ url('whosignup') }}">{{ __('Open an Account') }}</a> {{ __('or') }} <a href="{{ route('login') }}">{{ __('Login') }}</a> {{ __('to enjoy the tax benefits.') }}</p>
                                                                       </span>
                </div>
            <!-- <div class="col-md-3 col-6 measure-cell">
            ...
            async function callback(response, status) {
                ...
                if (distance) {
                    ...
                    if (van_type_checked == "box") {
                        ...
                        $("#tail_lift_img").attr("src", "{{asset('img/icon/checkbox-unchecked-black.png')}}");
                    }
    ...
    <script>
        ...
        $(function () {
            ...
            $("#submitbtn").click(function (e) {
                ...
                var pickup_country_select = $("#pickup_country_select").val();
                var desti_country_select = $("#desti_country_select").val();
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.status == '5') {
                            ...
                            //setTimeout(() => {
                               // $("#sender_submit").val(sender_city)
                               /// $("#receiver_city_submit").val(receiver_city)
                              //  $("#invoice_submit").submit();
        ...
        $("#pickup_country_select, #desti_country_select").change(function () {
            ...
            if ($("#pickup_country_select").val() !== 'Select Option' && $("#desti_country_select").val() !== 'Select Option') {
                ...
                $.get('{{url('company/companyQuote/get')}}' + "/" + $("#pickup_country_select").val() + "/" + $("#desti_country_select").val(), {}, function (data) {
                    ...
                    sender_tel.setNumber("{{isset(session('price_page')['sender_phone']) ? session('price_page')['sender_phone'] : ''}}")

                    setTimeout(function(){

                        $("#sender_phone").val("{{isset(session('price_page')['sender_phone']) ? session('price_page')['sender_phone'] : ''}}")
                    }, 3000)
                    var receiver_tel = window.intlTelInput(receiver_phone, {
                        initialCountry: destination_country,
                        formatOnDisplay: true,
                    ...
                    receiver_tel.setNumber("{{isset(session('price_page')['receiver_phone']) ?session('price_page')['receiver_phone'] :  ''}}")

                    setTimeout(function(){

                        $("#receiver_phone").val("{{isset(session('price_page')['receiver_phone']) ? session('price_page')['receiver_phone'] : ''}}")
                    }, 3000)

                    let contact_tel = window.intlTelInput(contact_phone, {
                        initialCountry: pickup_country,
                        formatOnDisplay: true,
                        separateDialCode: true,
                        hiddenInput: "contact_full_phone",
                    ...
                    contact_tel.setNumber("{{isset(session('price_page')['contact_phone']) ? session('price_page')['contact_phone'] : ''}}")
                    setTimeout(function(){
