        ...
        <div class="row d-flex justify-content-center">
            <div class="row dt-content mt-5">
                <div class="col-md-12 text-right mb-5 d-flex justify-content-between">
                    <h1 class="mt-0 fredoka">Guest Request Management</h1>
                    <div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('adminGuestRequest.index') }}",
                columns: [
            ...
            $('body').on('click', '.editProduct', function () {
                ...
                $.get("{{ route('adminGuestRequest.index') }}" +'/' + repair_id +'/edit', function (data) {
            ...
            $('#saveBtn').click(function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('adminGuestRequest.store') }}",
                    type: "POST",
                    dataType: 'json',
            ...
            $('body').on('click', '.deleteProduct', function (){
                ...
                if(result){
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('adminGuestRequest.store') }}"+'/'+repair_id,
                        success: function (data) {
                            table.draw();
                        },
                        error: function (data) {
