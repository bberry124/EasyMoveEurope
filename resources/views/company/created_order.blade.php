            ...
            <div class="row g-0">
                ...
                <form method="post" class="php-email-form">
                            ...
                            <div class="col-12 mt-4">
                                ...
                                <select class="form-control" id="pickup_country_select" name="pickup_country_select">
                                    @foreach(allCountries() as $key => $country)
                                        <option
                                                value="{{$key}}" {{isset(session('price_page')['pickup_country_select']) &&  session('price_page')['pickup_country_select'] == $key ? 'selected' : ''}}>{{__("$country")}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-12 col-md-6 personal-infos mb-3">
                            ...
                            <div class="col-12 mt-4">
                                ...
                                <select class="form-control" id="desti_country_select" name="desti_country_select">
                                    @foreach(allCountries() as $key => $country)
                                        <option
                                                value="{{$key}}" {{isset(session('price_page')['desti_country_select']) &&  session('price_page')['desti_country_select'] == $key ? 'selected' : ''}}>{{__("$country")}}</option>
                                    @endforeach
                                </select>
                    ...
                    @guest
                        ...
                        <div class="col-lg-12" style="font-size: 14px;display:none;">
                        ...
                        <div class="d-none d-md-block">
                            ...
                            <div class="row g-2 py-2 text-uppercase text-center heading" style="font-size: 12px;">
                                ...
                                <div class="col-2"><img src="{{ asset('img/icon/load-size.svg') }}" alt="" loading="lazy">
                                    <span>{{__("Max load size")}} (cm)</span></div>
