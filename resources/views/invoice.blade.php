...
@section("content")
    <div class="container bootstrap snippets bootdeys">
        <div class="row">
            ...
            <form id="price_form" style="display:none" method="get" action = "{{route('price.index')}}">

                <input type="hidden" name="destination_country" value="{{session('price_page')['desti_country']}}">
                <input type="hidden" name="pickup_country" value="{{session('price_page')['pickup_country']}}">
                <input type="hidden" name="id" value="{{$reqItems->first()->id}}">
                        ...
                        @foreach($reqItems as $key => $reqItem)
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 top-left">
                                    <a href="javascript:void(0)" onclick="$('#price_form').submit()" type="button" style="color: #D3D3D3;" style="color: #D3D3D3;" class="fa fa-arrow-left"></a>
                        ...
                        {{--{{dd(session()->all())}}--}}
                            ...
                            <div class="row table-row">
                                <table class="table table-striped table-bordered">
                                    <thead>
                                    <tr>
                                        <th style="width:10%">{{__('Van Type')}}</th>
                                        <th class="text-right" style="width:15%">{{__('Extras')}}</th>
                                        <th class="text-right" style="width:35%">{{__('Content')}}</th>
                                        <th class="text-right" style="width:10%">{{__('Value')}}</th>
                                        <th class="text-right" style="width:10%">{{__('Special Notes')}}</th>
                                        <th class="text-right" style="width:10%">{{__('Distance')}}</th>
