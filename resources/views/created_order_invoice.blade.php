                        ...
                        @foreach($reqItems as $key => $reqItem)
                            <div class="row">
                                ...
                                <div class="col-sm-6 top-left">
                                    <a href="{{route('user.create_order')}}"  type="button"
                                       style="color: #D3D3D3;" class="fa fa-arrow-left"></a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 from who-info">
                                    ...
                                    <p>{{__('Phone:')}} {{getCountryCode(session('price_page')['pickup_country_select']). $reqItem->sender_phone}}</p>
                                </div>

                                <div class="col-4 to who-info">
                                    <p class="lead marginbottom">To : {{ $reqItem->receiver }}</p>
                                    <p>{{ $reqItem->receiver_city }}</p>
                                    <p>{{__('Phone:')}} {{getCountryCode(session('price_page')['desti_country_select']). $reqItem->receiver_phone }}</p>
                                </div>
                                ...
                                <div class="col-4 payment-details">
                                    ...
                                    <p>{{__('Phone:')}} {{getCountryCode(session('price_page')['desti_country_select']). $reqItem->contact_phone }}</p>
